 ...
 */
Ext.define('FM.ux.view.iconChooser.Window', {
    ...
    setSelectIcon: function(idx) {
    	this.down('iconbrowser').selModel.select(idx);
    	
    	this.fireEvent('selectionchange', this.down('iconbrowser').selModel,this.down('iconbrowser').selModel.getSelection());
    },
    ...
    getIconbrowser:function(){
    	return this.down('iconbrowser');
    },
    getIconbrowserStore:function(){
    	return this.getIconbrowser().store;
    },
    setUrl:function(url){
    	return this.getIconbrowserStore().getProxy().url=url;
    }
