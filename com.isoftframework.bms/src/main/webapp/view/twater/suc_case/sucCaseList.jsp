...
<body>
	<div class="barnavtop">您所在的位置：成功案例管理</div>
	<div id="workspace">
		...
		<div
			...
			<div style="text-align: right; height: 30px; margin-top: 10px">
				<span style="float: left; font-size: 14px; font-weight: bold">成功案例管理
				</span>
			</div>
				...
				<table id="CmsSiteList_table" class="tableRegion" width="100%"
					...
					<thead>
						<tr>
							...
							<td width="17%" class="tableHeader" title="发生时间"><a
								href="javascript:void(0)" id="t_occur_time">发生时间</a></td>
						 
							<td class="tableHeader" width="14%">操作</td>
						</tr>
						<tr>
							<form action="listSucCase.do" name="queryForm" id="queryForm"
								method="post">
								<td class="statusBar">&nbsp;</td>
								
								<td align="center" class="statusBar">
								<input type="text" value="${param.name}" name="name"
									class="x_inputjing" />
								</td>
								
								<td align="center" class="statusBar">
								<input type="text"
									value="${param.occurTime}" name="occurTime" id="occurTime"  class="x_inputjing" />
								</td>
								 
								<td align="center" class="statusBar">
								<a class="sexybutton" href="#" onclick="queryForm.submit();">
									<span><span>搜索</span></span> 
								</a>
								<a class="sexybutton" href="#" onclick="javascript:queryAll();">
